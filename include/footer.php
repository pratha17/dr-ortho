<div class="footer-wrap">
            ...
            <div class="ad columns large-12">
                ...
                <div class="ad-contacts columns large-4">
                    <p class="phone">
                        ...
                        <a href="tel: 918 2345 123">918 2345 123</a>					
                    </p><!-- /.phone -->
                </div><!-- /.ad-contacts -->
                <div class="columns large-1">
                </div>
    ...
    <div class="footer">
        ...
        <div class="row">
            <p class="copyright">Copyright 2018. All Rights Reserved.  Designed & Developed by <a href="https://netcoders.in" target="_blank">NetCoders</a></p><!-- /.copyright -->
        </div><!-- /.row -->
    </div><!-- /.footer -->	
</div><!-- /.wrapper -->
